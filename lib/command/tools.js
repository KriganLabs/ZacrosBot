...
cmd.on('shorturl',['shorturl','sl'],['tools'],async(msg,{query,client})=> {
let q = query.split(" ");
if (!q[0]) return client.sendText(msg.from, "Masukan link",msg);
let data = (await axios.post("https://sl.azyansah.tech/", {
"url": q[0],
"code": q[1] ? q[1] : ''
}
)).data
return client.reply(msg,data.url)
