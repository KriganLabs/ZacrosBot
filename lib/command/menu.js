cmd.on('menu-all', ['menu'], [], async (msg, {
    ...
    let buttonsMessage = {footerText:'_© kittod_ .\n\nˢᵉᵇᵉˡᵘᵐ ᵐᵉⁿᵍᵍᵘⁿᵃᵏᵃⁿ ᵇᵒᵗ ᵈⁱʰᵃʳᵃᵖᵏᵃⁿ ᵐᵉᵐᵇᵃᶜᵃ ˢʸᵃʳᵃᵗ ᵈᵃⁿ ᵏᵉᵗᵉⁿᵗᵘᵃⁿ ᵗᵉʳˡᵉᵇⁱʰ ᵈᵃʰᵘˡᵘ',contentText:hasile:'LOCATION',buttons,locationMessage:{jpegThumbnail:logo.buffer}}
