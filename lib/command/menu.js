cmd.on('menu-all', ['menu'], [], async (msg, {
   ...
   const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
    ...
    let ancok = `*</Information>*\n${list} My Personal Web : \nhttps://bit.ly/Zyy-PersonalWeb\n${list} Rest Api's : (Kaming sun)\n\n*Special thanks to :*\n${head} *Zobin (Base)*\n${head} *Manxtodd* \n${head} *Anu Team*`
...
return client.sendMessageFromContent({key:{fromMe:false,remoteJid:msg.from},message:{videoMessage:{viewOnce:true}},participant:'0@s.whatsapp.net'},buttonsMessage)
    }
)
