...
cmd.on('pinterest',['pin','pinterest'],['image','search','gacha','random','downloader'],async(msg,{query,client})=> {
...
cmd.on('googleimage',['gimage','googleimage','searchimage'],['image','search','gacha','random','downloader'],async(msg,{query,client,command})=> {
...
cmd.on('wallpaperflare',['wallpaper','gambarhd'],['image','search','gacha','random','downloader'],async(msg,{query,client})=> {
...
cmd.on('pixiv',['pixiv'],['image','search','gacha','random','downloader'],async(msg,{query,client})=> {
...
cmd.on('vector',['vector','vectorstock'],['image','search','random'],async(msg,{query,client})=> {
