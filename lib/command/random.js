...
cmd.on("randomtag", ["furry","gay","stress","jadian", "ganteng", "cantik", "pdkt", "jelek", "burik", "sholeh", "fanatik", "kurus", "gemuk"], ["random","group"], async (msg, res) => {
...
cmd.on("asupan", ["asupan","asupanv1","asupanv2", "asupanv3"], ["random"], async (msg, res) => {
