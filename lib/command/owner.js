...
return client.reply(msg,functions.util.format(evaluate), {quoted : msg, contextInfo: { externalAdReply: { title: 'Zacros', "body": 'Multipurpose Whatsapp bot using baileys library!', thumbnailUrl:'https://i.pinimg.com/736x/d9/dd/05/d9dd0569752b0cd67919d4b4053d8347.jpg', sourceUrl: 'https://github.com/Zacros-Team/ZacrosBot/'}}});
} catch(e){
return res.client.reply(msg,functions.util.format(e), {quoted : msg, contextInfo: { externalAdReply: { title: 'Zacros', "body": 'Multipurpose Whatsapp bot using baileys library!', thumbnailUrl:'https://i.pinimg.com/736x/d9/dd/05/d9dd0569752b0cd67919d4b4053d8347.jpg', sourceUrl: 'https://github.com/Zacros-Team/ZacrosBot/'}}});
}
