...
let buttonsMessage = {footerText:`\n© Zyy.`,contentText:functions.parseResult(type,'Youtube Download')+`\n\nNote :Jika Tidak Bisa Menekan Tombol / WA MOD, Ketik ${prefix[0]}ytmp3/4 ${res.url}`,buttons,locationMessage:{jpegThumbnail:logo.buffer},headerType:"LOCATION"}
