...
let res = command.endsWith('doc') || command.endsWith('dokumen') || command.endsWith('doc') ? {type:'documentMessage',mimetype:'audio/mpeg',filename:type.output,quoted:msg} : {type:'documentMessage',mimetype:'video/mp4',filename:type.output,quoted:msg}
