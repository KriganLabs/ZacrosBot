...
let buttonsMessage = {footerText:`\n© Zyy.`,contentText:functions.parseResult(data,'Youtube Play')+`\n\nNote :Jika Tidak Bisa Menekan Tombol / WA MOD, Ketik ${prefix[0]}ytmp3/4 ${data.url}`,buttons,locationMessage:{jpegThumbnail:logo.buffer},headerType:"LOCATION"}
