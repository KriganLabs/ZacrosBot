/*cmd.on('help', ['bot'], ['info'], async (msg, {
    query,
    client,
    prefix,
    command
    ...
    let buttonsMessage = {
    contentText: `*Hai ${msg.sender.name}*

Ingin menggunakan bot? kamu bisa klik tombol menu di bawah ini ya!`,
...
cmd.on('menu-cmd', ['menu','help','command','commands'], ['info'], async (msg, {
    prefix,
    client,
    query,
    usedPrefix
