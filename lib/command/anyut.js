...
cmd.on('menu-cmd', ['menu'], ['info'], async (msg, {
  ...
  "listMessage": {
    ...
    "description": `Berikut Daftar Menunya!\n/*\nTekan tombol yg bertuliskan "Daftar Menu" yaa! Jika Tidak Bisa Di Tekan, Tekan Tombol Baca Selengkapnya!${String.fromCharCode(3006).repeat(10)}\n${functions.parseResult(list_nitip,{body:`${list} _%value_`})}*/`,
    "footerText": `ᵖᵒʷᵉʳᵉᵈ ᵇʸ ᶻᵃᶜʳᵒˢ ᵗᵉᵃᵐ`,
    ...
    buttons = [{
        ...
        buttonText: {
        displayText: '𝐂𝐀𝐑𝐀 𝐏𝐄𝐍𝐆𝐆𝐔𝐍𝐀𝐀𝐍'
        },
        type: 1
    },{
        buttonId: prefix[0]+'information',
        buttonText: {
        displayText: '𝐒𝐘𝐀𝐑𝐀𝐓 & 𝐊𝐄𝐓𝐄𝐍𝐓𝐔𝐀𝐍'
        },
        type: 1
    }]
   let buttonsMessage = {
        contentText: hasil,
        footerText: `𝙋𝙤𝙬𝙚𝙧𝙚𝙙 𝘽𝙮 𝙕𝙖𝙘𝙧𝙤𝙨 𝙏𝙚𝙖𝙢`,
        buttons,
        headerType: 1
    }
return client.sendMessageFromContent(msg.from,{buttonsMessage})
...
return client.sendText(msg.from,`*Hai ${msg.sender.name}*
...
*</My Social Media>*
Facebook : https://www.facebook.com/azyansahxd
Instagram : https://www.instagram.com/creallizy.xd
Github : https://github.com/Azyansah
