...
cmd.on('tebakgambar', ['tebakgambar'],['game'], async(msg, {usedPref}) => {
	timeout = 120000
         jidnye = msg.from
...
cmd.on('tebaklagu', ['tebaklagu'],['game'], async(msg, {usedPref}) => {
	timeout = 120000
         jidnye = msg.from
...
cmd.on('tebakkata', ['tebakkata'],['game'], async(msg, {usedPref}) => {
	timeout = 120000
         jidnye = msg.from
...
cmd.on('dare',['dare'],['game'],async(msg, {
  command, client}) => {
...
cmd.on('truth',['truth'],['game'],async(msg, {
  command, client}) => {
