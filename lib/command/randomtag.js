cmd.on(
  ...
  async (msg, res) => {
    let groupMembers1 =
      msg.groupData.participants[
        Math.floor(Math.random() * msg.groupData.participants.length)
      ].jid;
    let groupMembers2 =
      msg.groupData.participants[
        Math.floor(Math.random() * msg.groupData.participants.length)
    ...
    if (res.command === "jadian") {
      client.sendMessage(
        msg.from,
        "Ciee yang lagi jadian @" +
          groupMembers1.split("@")[0] +
          " <3 @" +
          groupMembers2.split("@")[0],
        "conversation",
        {
          contextInfo: {
      ...
      client.sendMessage(
        msg.from,
        "NJIRRRR ADA LORDDD @" + groupMembers1.split("@")[0],
        "conversation",
        {
          contextInfo: {
      ...
      client.sendMessage(
        msg.from,
        "Aowkaowkaow furry lo ange sama hewan @" + groupMembers1.split("@")[0],
        "conversation",
        {
          contextInfo: {
            mentionedJid: [groupMembers1],
      ...
      client.sendMessage(
        msg.from,
        "ANJG STRESSSSSS @" + groupMembers1.split("@")[0],
        "conversation",
        {
          contextInfo: {
            mentionedJid: [groupMembers1],
      ...
      client.sendMessage(
        msg.from,
        "Hai ganteng @" + groupMembers2.split("@")[0],
        "conversation",
        {
          contextInfo: {
      ...
      client.sendMessage(
        msg.from,
        "Yang jelek disini @" + groupMembers2.split("@")[0] + "kok lu jelek?",
        "conversation",
        {
          contextInfo: {
            mentionedJid: [groupMembers2],
      ...
      client.sendMessage(
        msg.from,
        "yang fanatik disini @" + groupMembers2.split("@")[0] + "tch fanatik",
        "conversation",
        {
          contextInfo: {
            mentionedJid: [groupMembers2],
