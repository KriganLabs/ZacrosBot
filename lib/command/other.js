const fs = require("fs")
    ...
    const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net",   "remoteJid": "6289523258649-1604595598@g.us"  }, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: thumbnail, surface: 200, message: `R-Bot ?\nBy Rama?`, orderTitle: '?', sellerJid: '0@s.whatsapp.net'}},sendEphemeral: true}
}
...
Best regards, @${botinfo.ownerNumber[0]}.`
  client.reply(msg, txxt, {contextInfo:{mentionedJid:functions.parseMention(txxt), {quoted:ftroli})}})
});
...
Dana : 081515589573 (Unknown)`
return await client.sendText(msg.from, dmsg, msg),{quoted:ftroli});
});
