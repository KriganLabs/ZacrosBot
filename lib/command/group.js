...
cmd.on('hidetag',['hidetag','everyone'],['group'],async(msg,{query,client})=> {
return client.sendHidetag(msg.from,query,'extendedTextMessage')
},{query: 'Masukkan query',param:functions.needed('query'),admin: true, clientAdmin:true, group:true});
