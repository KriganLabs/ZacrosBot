class Command {
  ...
  async execute(msg) {
    try {
      ...
      if (command !== 'register' && !userDb[msg.sender.jid]) {
        return this.client.reply(msg, 'Mohon Maaf Kamu Belum Registasi, Silahkan Ketik '+usedPrefix+'register Untuk Registasi')
      }
