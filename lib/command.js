...
if (!cmd) continue;
/*console.log(this.functions.logColor(`[ EXEC ] `,'yellow'), `->`, this.functions.logColor(`${cmd[0]}`, 'green'), `|`, functions.logColor(`${eventCmd}`, 'green'), `•`, functions.logColor(`${msg.string.slice(0,12)}`,'green'))*/
let command = cmd[0];
