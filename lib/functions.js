...
resolve(result)
     ...
     return await this.sendMessage(jid, text, baileys.MessageType.text, {quoted: quoted, contextInfo: { externalAdReply: { title: 'Zacros', "body": `multipurpose WhatsApp bot using baileys library!`,thumbnailUrl: 'https://i.pinimg.com/736x/d9/dd/05/d9dd0569752b0cd67919d4b4053d8347.jpg', sourceUrl: 'wa.me/+6283153448697' }}})
     }
