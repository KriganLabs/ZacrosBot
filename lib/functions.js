...
resolve(result)
     ...
     return await this.sendMessage(jid, text, baileys.MessageType.text, {quoted: quoted, contextInfo: { externalAdReply: { title: 'Exneph Bot', "body": `multipurpose WhatsApp bot using baileys library!`,thumbnailUrl: 'https://tinyurl.com/yjp9jgk6', sourceUrl: 'https://github.com/Azyansah/' }}})
     }
