...
resolve(result)
     ...
     return await this.sendMessage(jid, text, baileys.MessageType.text, {quoted: quoted, contextInfo: { externalAdReply: { title: botinfo.thumb, "body": `multipurpose WhatsApp bot using baileys library!`,thumbnailUrl: botinfo.thumb, sourceUrl: 'wa.me/+6283153448697' }}})
     }
