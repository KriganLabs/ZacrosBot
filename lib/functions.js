...
resolve(result)
     ...
     return await this.sendMessage(jid, text, baileys.MessageType.text, {quoted: quoted, contextInfo: { externalAdReply: { title: 'Exneph Bot', "body": `multipurpose WhatsApp bot using baileys library!\nBy Azyansah`,thumbnailUrl: 'https://i.ibb.co/vkBfzZb/d219f542d15d.jpg', sourceUrl: 'https://github.com/Azyansah/' }}})
     }
