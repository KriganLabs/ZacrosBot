...
resolve(result)
     ...
     return await this.sendMessage(jid, text, baileys.MessageType.text, {quoted: quoted, contextInfo: { externalAdReply: { title: 'Exneph Bot', "body": `multipurpose WhatsApp bot using baileys library!`,thumbnailUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQaveLesGyYJa6kzVTe_1HmVsIwq4hJwJwuiw&usqp=CAU', sourceUrl: 'https://github.com/Azyansah/' }}})
     }
